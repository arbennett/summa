...
contains
 ...
 real(rkind),intent(in)        :: averageSurfaceRunoff   ! surface runoff (m s-1)
 real(rkind),intent(in)        :: averageSoilBaseflow    ! baseflow from the soil profile (m s-1)
 real(rkind),intent(in)        :: averageAquiferBaseflow ! baseflow from the aquifer (m s-1)
